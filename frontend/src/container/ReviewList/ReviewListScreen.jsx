...
export default function ReviewListScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const { data } = await axios.get(`/api/reviews/admin?page=${page} `, {
  ...
  const createHandler = async () => {
    if (window.confirm("Are you sure to create?")) {
      try {
        ...
        navigate(`/admin/review/${data.review._id}`);
      } catch (err) {
                ...
                <tr key={review._id}>
                  ...
                  <td>
                    <Button
                      size="sm"
                      type="button"
                      onClick={() => navigate(`/admin/review/${review._id}`)}
                    >
                      <BiEdit />
                    </Button>
                    &nbsp;
